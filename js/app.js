...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${product.image}></img>
      ...
      <p><b>Average Rating: ${product.rating.rate}</b></p>
      <p><b>Total Number of Review: ${product.rating.count}</b></p>
...
const addToCart = (id, price) => {
  count = count + 1;
  // price update function called 
  updatePrice("price", price);
  // tax price count update function called
  updateTaxAndCharge();
  // total price update function count 
  updateTotal();
